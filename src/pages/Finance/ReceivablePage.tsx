        ...
        <div className="flex-1 flex flex-col h-full bg-gray-50 overflow-hidden">
            ...
            <header className="bg-white border-b border-gray-200 flex flex-col sm:flex-row items-start sm:items-center justify-between px-4 sm:px-6 py-3 sm:py-0 sm:h-16 shrink-0 z-10 gap-3">
                ...
                <div className="flex items-center gap-2 sm:gap-4 w-full sm:w-auto">
                    <button
                        onClick={handleNew}
                        className="flex items-center justify-center gap-2 px-3 sm:px-4 py-2 bg-green-600 text-white text-sm font-bold rounded-lg hover:bg-green-700 transition-all shadow-sm shadow-green-200 w-full sm:w-auto"
                    >
